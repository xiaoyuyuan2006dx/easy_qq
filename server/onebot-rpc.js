...
function buildUploadFileParams(type, id, fileSeg) {
  ...
  if (type === 'group') return { action: 'upload_group_file', params: { group_id: Number(id), file: resolvedSource, name, upload_file: true }, localPath, nameVariants };
  return { action: 'upload_private_file', params: { user_id: Number(id), file: resolvedSource, name, upload_file: true }, localPath, nameVariants };
}
